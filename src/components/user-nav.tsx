  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" className="relative h-10 w-10 sm:h-8 sm:w-8 rounded-full">
      ...
      <DropdownMenuContent className="w-48 sm:w-56 glass-strong" align="end" forceMount>
